...
const menuGroups: MenuGroup[] = [
  // 1. ABOUT US
  {
    ...
    dropdown: [
      ...
      { label: 'Code of Conduct', href: resolveUploadedAssetUrl('/pdfs/Aboutus/Codeofconduct/Code-of-Conduct-1.pdf') || '/pdfs/Aboutus/Codeofconduct/Code-of-Conduct-1.pdf' },
  ...
  // 4. ACADEMICS
  {
    ...
    dropdown: [
      { label: "Dean Academics Desk", href: '/dean-academics' },
      {
        ...
        subItems: [
          { label: 'EVEN SEM 2025-26 SE TE BE (Tentative)', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic_Calendar_Even_2025-26.pdf') || '/pdfs/Academics/AcademicCalender/Academic_Calendar_Even_2025-26.pdf' },
          { label: 'ODD SEM 2025-26 SE TE BE', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/acad-calen-odd-25-26(SE,TE,BE).pdf') || '/pdfs/Academics/AcademicCalender/acad-calen-odd-25-26(SE,TE,BE).pdf' },
          { label: 'EVEN SEM 2024-25', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic_Calender_2024_25_Even_2025-1.pdf') || '/pdfs/Academics/AcademicCalender/Academic_Calender_2024_25_Even_2025-1.pdf' },
          { label: 'ODD SEM 2024-25 FE ME', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic_Calendar_Odd-24-25(FE,ME,Sem1).pdf') || '/pdfs/Academics/AcademicCalender/Academic_Calendar_Odd-24-25(FE,ME,Sem1).pdf' },
          { label: 'ODD SEM 2024-25 SE TE BE', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic_Calendar_Odd-24-25(SE,TE,BE).pdf') || '/pdfs/Academics/AcademicCalender/Academic_Calendar_Odd-24-25(SE,TE,BE).pdf' },
          { label: 'EVEN SEM 2023-24 SE TE BE', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic-Calendar_Even-Sem_-2023-2024.pdf') || '/pdfs/Academics/AcademicCalender/Academic-Calendar_Even-Sem_-2023-2024.pdf' },
          { label: 'EVEN SEM 2022-23 SE TE BE', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic-Calendar-Even-Semester-2022-23-SE-TE-BE.pdf') || '/pdfs/Academics/AcademicCalender/Academic-Calendar-Even-Semester-2022-23-SE-TE-BE.pdf' },
          { label: 'FE & ME EVEN SEM 2022-23', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/FE_SemII_Academic_Calendar2022-23(EvenSem).pdf') || '/pdfs/Academics/AcademicCalender/FE_SemII_Academic_Calendar2022-23(EvenSem).pdf' },
          { label: 'FE ODD SEM 2022-23', href: resolveUploadedAssetUrl('/pdfs/Academics/AcademicCalender/Academic-Calendar-Odd-Semester-2022-23-F.E.pdf') || '/pdfs/Academics/AcademicCalender/Academic-Calendar-Odd-Semester-2022-23-F.E.pdf' },
        ],
      },
  ...
  // 9. COMMITTEES
  {
    ...
    dropdown: [
      ...
      { label: 'Equal Opportunity Cell', href: resolveUploadedAssetUrl('/pdfs/Committees/EqualOpportunityCell/EOC-Committee.pdf') || '/pdfs/Committees/EqualOpportunityCell/EOC-Committee.pdf' },
      { label: 'Socio-Economically Disadvantaged Groups Cell', href: resolveUploadedAssetUrl('/pdfs/Committees/Socio-EconomicallyDisadvantagedGroupsCell/SEDG.pdf') || '/pdfs/Committees/Socio-EconomicallyDisadvantagedGroupsCell/SEDG.pdf' },
    ],
  },
