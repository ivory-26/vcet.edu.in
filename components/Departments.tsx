...
const departments: Card[] = [
  {
    ...
    src: '/images/Departments/Computer Engineering/InfrastructurecompsLAB-05.jpg',
    href: '/computer-engineering',
  },
  {
    title: 'Computer Science & Engineering (Data Science)',
    description: 'Data Science, AI & Applied Analytics',
    src: '/images/Departments/Computer Engineering/InfrastructurecompsLAB-02.jpg',
    href: '/cs-data-science',
  },
  {
    title: 'Information Technology',
    description: 'Cloud, Security & Enterprise Computing',
    src: '/images/Departments/Information Technology/infrastructureinftIT-LAB-12-scaled.jpg',
    href: '/information-technology',
  },
  {
    title: 'Artificial Intelligence & Data Science',
    description: 'Machine Learning & Intelligent Systems',
    src: '/images/Departments/Information Technology/infrastructureinftIT-LAB11-scaled.jpg',
  ...
  },
  {
    ...
    src: '/images/Departments/Electronics & Telecommunication/extc-infra-Microwave-And-Antenna-Laboratory.png',
    href: '/electronics-telecomm',
  },
  {
    title: 'Civil Engineering',
    description: 'Infrastructure, Planning & Sustainability',
    src: '/images/Departments/Civil Engineering/civi-infra-Transportation-Engineering-Lab.jpg',
    href: '/civil-engineering',
  },
  {
    title: 'Master of Management Studies (MBA)',
    description: 'Management Studies, Strategy & Leadership',
    src: '/images/Departments/MMS(MBA)/faciliteis/classroom-1.jpeg',
    href: '/mms',
  },
];
