...
let MOCK_RESEARCH: ResearchData[] = [
  {
    ...
    description: 'Institutional R&D Hub and PhD datasets.',
    hubCards: Array.from({ length: 4 }, () => ({ title: '', description: '' })),
    objectives: [],
    phdPursuing: [],
    phdHolders: [],
    dean: { name: '', designation: '', researchInterest: '' },
    quickLinks: Array.from({ length: 6 }, () => ({ label: '', url: '' })),
  },
  {
    id: '2',
    slug: 'funded-research',
    name: 'Funded Research',
    description: 'External funding records and reports.',
    funding: [],
    fundingReport: { label: 'Funded Research Report', url: '' },
  },
  {
    id: '3',
    slug: 'publications',
    name: 'Publications',
    description: 'Books, Journals, and Conference papers.',
    books: [],
    journals: [],
    publicationPdfs: [
      { label: 'Books PDF', url: '' },
      { label: 'Conference PDF', url: '' },
      { label: 'Journal PDF', url: '' },
    ],
  },
  {
    id: '4',
    slug: 'patents',
    name: 'Patents',
    description: 'Intellectual property and patent records.',
    patents: [],
    patentYears: [],
    patentStats: {},
  },
  {
    ...
    description: 'Industry projects and revenue datasets.',
    consultancyRevenue: [],
    consultancyReport: { label: 'Consultancy Report', url: '' },
    industryPartners: [],
    consultancyStats: {},
  },
  {
    id: '6',
    slug: 'research-facility',
    name: 'Research Facility',
    description: 'Infrastructure and specialized R&D labs.',
    facilities: [],
  ...
  { id: '8', slug: 'research-policy', name: 'Research Policy', description: 'Institutional policy documents.', documents: [] },
  {
    ...
    slug: 'iic',
    name: 'IIC',
    description: 'Innovation cell achievements and reports.',
    iicAchievementsDetailed: [],
    iicGalleryDetailed: [],
    iicCommitteeGroups: { staff: [], expert: [], support: [], student: [] },
    iicReportsDetailed: [],
  },
  {
    id: '10',
    slug: 'nirf',
    name: 'NIRF',
    description: 'NIRF ranking documents.',
    nirfCards: [],
  },
  {
    id: '11',
    slug: 'downloads',
    name: 'Downloads',
    description: 'Research-related downloadable forms.',
    topButtons: [],
    leftLinks: [],
    rightLinks: [],
  },
