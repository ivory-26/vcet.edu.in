...
const NewsletterPreview: React.FC<NewsletterPreviewProps> = ({
  ...
  return (
    <div className="bg-white rounded-4xl p-6 shadow-sm border border-slate-100 sticky top-24">
      ...
      <div className="bg-slate-50/50 rounded-2xl p-6 border border-slate-100 flex flex-col gap-6 transition-all min-h-[400px]">
        ...
        <div>
          ...
          <h3 className="text-2xl font-black text-slate-800 mt-3 wrap-break-word">
        ...
        {/* Description */}
        <p className="text-slate-500 text-sm leading-relaxed whitespace-pre-wrap flex-1 wrap-break-word">
