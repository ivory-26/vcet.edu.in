...
const TeamPanel: React.FC = () => {
  ...
  return (
    <div ref={ref} className={`p-4 md:p-8 lg:p-12 space-y-8 md:space-y-12 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    ...
                    {tabs.map((tab) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-auto lg:w-full min-w-[200px] sm:min-w-[220px] lg:min-w-0 flex-shrink-0 text-left flex items-center gap-1.5 lg:gap-3.5 px-2.5 py-2 lg:py-3.5 transition-all duration-250 group relative min-h-[40px] ${isActive
