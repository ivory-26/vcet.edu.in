    ...
    <PageLayout>
      ...
      <section className="py-8 md:py-16 lg:py-24 bg-[#f8fafc]">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-6 md:gap-8 lg:gap-10">

            {/* Sidebar Nav — scrollable tabs on mobile, vertical sidebar on desktop */}
            <aside className="lg:col-span-1">
              <div className="sticky top-20 lg:top-28 space-y-4">
                ...
                <nav className="bg-white border border-slate-200 shadow-sm">
                  ...
                  {/* On mobile: horizontal scrolling tabs; on lg: vertical list */}
